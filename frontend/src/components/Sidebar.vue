  ...
  <aside class="sidebar" :class="{ collapsed: isCollapsed }">
    ...
    <nav class="sidebar-nav">
      ...
      <template v-if="auth.isAdmin">
        ...
        <router-link to="/document-types" class="nav-item" active-class="active"
          :title="isCollapsed ? 'Master Jenis Dokumen' : ''">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
            <polyline points="14 2 14 8 20 8" />
        ...
        <router-link to="/users" class="nav-item" active-class="active"
          :title="isCollapsed ? 'Kelola User & Penilai' : ''">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
        ...
        <router-link to="/reviews" class="nav-item" active-class="active"
          :title="isCollapsed ? 'Penilaian Project' : ''">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
        ...
        <router-link to="/reviews/history" class="nav-item" active-class="active"
          :title="isCollapsed ? 'Riwayat Penilaian' : ''">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
        ...
        <router-link to="/whatsapp-settings" class="nav-item" active-class="active"
          :title="isCollapsed ? 'Gateway WhatsApp' : ''">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
            <path
              d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
          </svg>
          <span v-if="!isCollapsed">Gateway WhatsApp</span>
        </router-link>
      </template>
...
.collapsed .sidebar-nav .nav-item {
  justify-content: center;
  padding: 0.65rem;
}
